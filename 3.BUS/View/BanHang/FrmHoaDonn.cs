...
namespace _3.GUI.View.BanHang
{
    public partial class FrmHoaDonn : Form
    {
       ...
       private hoaDon _HD;
        ...
        {
            if (e.RowIndex >= 0 && dtgv_hoaDon.Rows[e.RowIndex].Cells[0].Value != null)
            {
        ...
        private void btn_xoa_Click(object sender, EventArgs e)
        {
            ...
            }else if(tbt_SDT.Text == "0123456789")
            {
                ...
                //var updateSP = _qLsanPhamChiTiet.getViewSanPhamCT().FirstOrDefault(p => p.SanPhamChiTiets.IDsanPham == HDCT.IDSanPham);
                //updateSP.SanPhamChiTiets.Soluong = updateSP.SanPhamChiTiets.Soluong += HDCT.Soluong;
                //_qLsanPhamChiTiet.UpdateSanPham(updateSP.SanPhamChiTiets);
        ...
        private void btn_clear_Click(object sender, EventArgs e)
        {
            ...
            tbt_maNV.Text= null;
            tbt_SDT.Text = null;
            tbt_tongTien.Text = null;
            tbt_ghiChu.Text = null;
        }
    }
}
