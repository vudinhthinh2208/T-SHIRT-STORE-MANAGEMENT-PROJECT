...
namespace _1.DAL.Context
{
    public class DatabaseContext : DbContext
    {
        ...
        protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
        {
            ...
            {
                //optionsBuilder.UseSqlServer(@"Data Source=LAPTOP-25M23VCQ\SQLEXPRESS;Initial Catalog=TestL2;Integrated Security=True");
                //optionsBuilder.UseSqlServer(@"Data Source=LAPTOP-4C55HFD4\SQLEXPRESS;Initial Catalog=DuAn1_All;Integrated Security=True");
                optionsBuilder.UseSqlServer(@"Data Source=LAPTOP-25M23VCQ\SQLEXPRESS;Initial Catalog=DuAn1_All;Integrated Security=True");
            }
        }
